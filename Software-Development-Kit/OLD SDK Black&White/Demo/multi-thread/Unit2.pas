...
uses
  Classes, windows, SysUtils, OleCtrls, zkemkeeper_TLB,Forms;
...
begin
  ...
  CZKEM1.Width := 0;
  CZKEM1.Parent := application.MainForm;
  resume;
end;
...
begin
  ...
  if CZKEM1.ReadGeneralLogData(DevID) then
    ...
    while CZKEM1.GetGeneralLogData(1,dwTMachine,dwEnrollNumber,dwEMachineNumber,dwVerifyMode,
